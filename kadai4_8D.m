...
a=0.7;b=0.8;c=10;d=1;X=-2:0.01:2;Y1=-(X.^3)/3+X;Y2=(X+a)/b;%ヌルクラインをプロットするためのベクトルX, Y1, Y2を用意
for T=1:Tmax-1
...
for T=1000:10:Tmax
    ...
    subplot(1,2,2);plot(X, Y1, X, Y2, V(71,51,T), W(71,51,T), '*');ylim([-1 1]);%ヌルクラインとともにV, Wの値を*でプロット
    pause(0.0001);
end